    ...
    function _approveContribRequest(reqId) {
      ...
      const html = '<div class="_mhdr"><h3><i class="fa-solid fa-circle-check" style="color:#22c55e;"></i> Approve Request</h3><button class="_mcls" onclick="closeModal()">×</button></div>'
        ...
        + '<label style="font-size:13px;font-weight:600;color:#334155;display:block;margin-bottom:6px;"><i class="fa-solid fa-tag" style="color:#C1440E;margin-right:4px;"></i> Contribution Type <span style="font-weight:400;color:#e74c3c;">*</span></label>'
    ...
    function runHealthCheck() {
      ...
      getData("getHealthCheck").then(function(res) {
        ...
        if (checks.email_limit && checks.email_used !== undefined) {
          ...
          var emailBdr = pct >= 90 ? "#fca5a5" : pct >= 70 ? "#E0987A" : "#86efac";
    ...
    function _hcRenderBanner(issues, warnings) {
      ...
      if (issues.length > 0) {
        ...
        cfg = { bg:"#fffbeb", border:"#E0987A", ico:"🟡", ttl:"Warnings", dtl: warnings.join(" · ") };
      } else {
