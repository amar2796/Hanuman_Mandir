        ...
        list.length === 0
          ? `<tr><td colspan="7" style="text-align:center;padding:36px 20px;">
              <div class="rt-empty-msg">
                ...
                <button onclick="document.getElementById('g_name').focus()" style="background:#C1440E;color:#fff;border:none;padding:8px 18px;border-radius:8px;font-size:12px;cursor:pointer;font-family:inherit;">
