    ...
    function previewBroadcast() {
      ...
      const prioColor = { urgent: "#ef4444", important: "#C1440E", normal: "#94a3b8", low: "#cbd5e1" };
      const prioBg = { urgent: "#fee2e2", important: "#FDF0E6", normal: "#f1f5f9", low: "#f8fafc" };
      ...
      openModal(
        `<div class="_mhdr"><h3><i class="fa-solid fa-eye"></i> Broadcast Preview</h3><button class="_mcls" onclick="closeModal()">×</button></div>
          ...
          <div class="_mft">
            ...
            <button class="_mbtn" style="background:#C1440E;" onclick="closeModal();sendBroadcast()"><i class="fa-solid fa-paper-plane"></i> Send Now</button>
          </div>`,
        "480px"
      );
    }
