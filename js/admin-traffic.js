    ...
    (function injectTcResetModal() {
      ...
      style.textContent =
        ...
        "#_tcResetWarn{background:#fef9ec;border:1px solid #E0987A;border-radius:10px;padding:10px 14px;margin:0 0 22px;font-size:11.5px;color:#92400e;font-family:Poppins,sans-serif;text-align:left;line-height:1.6;}" +
    ...
    function loadTrafficStats() {
      ...
      getData("getTrafficStats").then(function(d) {
        ...
        var doGetColor = doGetPct >= 90 ? "#dc2626" : doGetPct >= 70 ? "#C1440E" : "#22c55e";
        ...
        var emailColor = emailPct >= 90 ? "#dc2626" : emailPct >= 70 ? "#C1440E" : "#22c55e";
        ...
        var pills = [
          ...
          { label: "Today",       val: d.today,    color: "#C1440E", icon: "fa-calendar-day" },
          { label: "This Hour",   val: d.thisHour, color: "#16a34a", icon: "fa-clock" },
          { label: "Peak Hour",   val: d.peakHour, color: "#C1440E", icon: "fa-bolt" },
        ...
        renderBars("tc_hour_chart", d.last24Hours, "hour", "count", "#C1440E");
        renderBars("tc_day_chart",  d.last14Days,  "date", "count", "#C1440E");
                ...
                return '<tr style="border-bottom:1px solid #f1f5f9;">' +
                  ...
                  '<td style="padding:6px 0;width:90px;">' +
                    '<div style="height:6px;background:#f1f5f9;border-radius:3px;overflow:hidden;">' +
                      '<div style="height:6px;width:' + pct + '%;background:linear-gradient(90deg,#C1440E,#f59e0b);border-radius:3px;transition:width .4s;"></div>' +
                    '</div>' +
