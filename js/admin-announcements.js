var _annColorMap = {
      ...
      blue: "linear-gradient(90deg,#1e3a8a,#C1440E,#1e3a8a)",
    ...
    function selectAnnColor(color, el) {
      ...
      el.style.boxShadow = "0 0 0 3px " + (el.style.background.includes("7c3aed") ? "#7c3aed" :
        el.style.background.includes("d35400") ? "#C1440E" :
          el.style.background.includes("991b1b") ? "#dc2626" :
            el.style.background.includes("15803d") ? "#16a34a" :
              el.style.background.includes("1d4ed8") ? "#C1440E" :
      ...
      try {
        ...
        list.innerHTML = data.map(function (a, i) {
          ...
          return '<div class="ann-history-item' + (isActive ? " active-ann" : "") + '">' +
            ...
            '</div>' +
            (a.Badge ? '<span style="display:inline-block;margin-top:4px;background:#f0f4ff;color:#C1440E;border-radius:10px;padding:1px 8px;font-size:11px;font-weight:700;">' + escapeHtml(a.Badge) + '</span>' : '') +
      ...
      getCached("getYearlySummary")
        .then(function (res) {
          ...
          rows.forEach(function (r, idx) {
            ...
            if (isCurrentYear) {
              tr.style.background = "rgba(193, 68, 14,0.07)";
            ...
            tr.innerHTML =
              ...
              (isCurrentYear ? ' <span style="font-size:10px;background:#C1440E;color:#fff;border-radius:4px;padding:1px 6px;vertical-align:middle;">Current</span>' : '') +
              '</td>' +
              ...
              (closing < 0 ? "−" : "") + "₹" + fmt(Math.abs(closing)) +
              '</td>' +
              '<td style="text-align:right;color:#C1440E;">' + cfText + '</td>' +
        ...
        .catch(function (err) {
          ...
          if (el) el.innerHTML =
            ...
            "<button onclick='loadYearSummary()' style='background:#C1440E;color:#fff;border:none;border-radius:8px;padding:8px 20px;font-family:Poppins,sans-serif;font-size:13px;font-weight:700;cursor:pointer;box-shadow:0 3px 8px rgba(193, 68, 14,0.3);'>" +
