/* ═══════════════════════════════════════════════════════════════════
    ...
    function openAdminMyProfile() {
      ...
      let iconBox = (icon) => `<span style="width:24px;height:24px;background:#fff7ed;border-radius:7px;display:inline-flex;align-items:center;justify-content:center;"><i class="${icon}" style="color:#C1440E;font-size:11px;"></i></span>`;
      let html = `
        <div class="_mhdr" style="background:linear-gradient(135deg,#141b2d 0%,#2a0f00 60%,#3c1a00 100%);border-bottom:2px solid rgba(193, 68, 14,0.35);">
          <h3 style="color:#fff;display:flex;align-items:center;gap:8px;">
            <span style="width:28px;height:28px;background:rgba(193, 68, 14,0.18);border-radius:8px;display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;"><i class="fa-solid fa-id-card" style="color:#C1440E;font-size:13px;"></i></span> My Profile
          </h3>
        ...
        <div class="_mbdy" style="padding:0;">
          <div style="background:linear-gradient(180deg,#141b2d 0%,#2a0f00 60%,#3c1a00 100%);padding:26px 20px 20px;text-align:center;position:relative;overflow:hidden;">
            ...
            <div style="color:#C1440E;font-size:1.05rem;font-weight:700;margin-bottom:8px;">${escapeHtml(myProfile.Name || "—")}</div>
        ...
        <div class="_mft" style="flex-wrap:wrap;gap:8px;border-top:2px solid rgba(193, 68, 14,0.15);background:linear-gradient(90deg,rgba(193, 68, 14,0.04),transparent);">
          <button class="_mbtn" style="background:#64748b;box-shadow:none;" onclick="closeModal()"><i class="fa-solid fa-xmark"></i> Close</button>
          <button class="_mbtn" style="background:linear-gradient(135deg,#2a0f00,#3c1a00);box-shadow:0 3px 10px rgba(42,15,0,0.3);" onclick="closeModal();openAdminChangePassword()"><i class="fa-solid fa-key" style="color:#C1440E;"></i> Change Password</button>
          <button class="_mbtn" style="background:linear-gradient(135deg,#C1440E,#e8920a);box-shadow:0 3px 10px rgba(193, 68, 14,0.35);" onclick="closeModal();openAdminEditProfileForm()"><i class="fa-solid fa-user-pen"></i> Edit Profile</button>
        </div>`;
    ...
    function openAdminEditProfileForm(previewB64, prefillName, prefillEmail, prefillVillage, prefillAddress) {
      ...
      let html = `
        <div class="_mhdr" style="background:linear-gradient(135deg,#141b2d 0%,#2a0f00 60%,#3c1a00 100%);border-bottom:2px solid rgba(193, 68, 14,0.35);">
          <h3 style="color:#fff;display:flex;align-items:center;gap:8px;">
            <span style="width:28px;height:28px;background:rgba(193, 68, 14,0.18);border-radius:8px;display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;"><i class="fa-solid fa-user-pen" style="color:#C1440E;font-size:13px;"></i></span> Edit Profile
          </h3>
          <button class="_mcls" onclick="closeModal()" style="color:rgba(255,255,255,0.6);font-size:20px;line-height:1;background:none;border:none;cursor:pointer;padding:0;">×</button>
        </div>
        <div class="_mbdy" style="text-align:center;">
          <div style="position:relative;width:88px;margin:0 auto 10px;">
            <img id="adminPhotoPreview" src="${escapeHtml(photoSrc)}" onerror="this.src='${fb}'"
              style="width:88px;height:88px;border-radius:50%;object-fit:cover;border:3px solid #C1440E;background:#faeeda;display:block;margin-bottom:0;box-shadow:0 4px 14px rgba(193, 68, 14,0.25);"/>
            <div onclick="document.getElementById('adminPhotoFile').click()" style="position:absolute;bottom:2px;right:2px;width:28px;height:28px;background:#C1440E;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,.2);border:2.5px solid white;" title="Change Photo">
          ...
          <div style="text-align:left;">
            ...
            <div style="background:#f8f8f8;border:1.5px solid #eee;border-radius:8px;padding:10px 14px;display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
              <div style="display:flex;align-items:center;gap:8px;">
                <i class="fa-solid fa-mobile-screen" style="color:#C1440E;font-size:13px;"></i>
        ...
        <div class="_mft" style="border-top:2px solid rgba(193, 68, 14,0.15);background:linear-gradient(90deg,rgba(193, 68, 14,0.04),transparent);">
          ...
          <button class="_mbtn" style="background:linear-gradient(135deg,#C1440E,#e8920a);box-shadow:0 3px 10px rgba(193, 68, 14,0.35);" onclick="saveAdminProfile()"><i class="fa-solid fa-check"></i> Save Changes</button>
        </div>`;
      openModal(html, "460px");
    ...
    function openAdminChangePassword() {
      const html = `
        <div class="_mhdr" style="background:linear-gradient(135deg,#141b2d 0%,#2a0f00 60%,#3c1a00 100%);border-bottom:2px solid rgba(193, 68, 14,0.35);">
          <h3 style="color:#fff;display:flex;align-items:center;gap:8px;">
            <span style="width:28px;height:28px;background:rgba(193, 68, 14,0.18);border-radius:8px;display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;"><i class="fa-solid fa-key" style="color:#C1440E;font-size:13px;"></i></span> Change Password
          </h3>
          <button class="_mcls" onclick="closeModal()" style="color:rgba(255,255,255,0.6);font-size:20px;line-height:1;background:none;border:none;cursor:pointer;padding:0;">×</button>
        </div>
        <div class="_mbdy">
        ...
        <div class="_mft" style="border-top:2px solid rgba(193, 68, 14,0.15);background:linear-gradient(90deg,rgba(193, 68, 14,0.04),transparent);">
          ...
          <button class="_mbtn" id="adm_cp_save_btn" style="background:linear-gradient(135deg,#C1440E,#e8920a);box-shadow:0 3px 10px rgba(193, 68, 14,0.35);" onclick="saveAdminNewPassword()">
