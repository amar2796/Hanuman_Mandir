/* ═══════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════ */
    ...
    function triggerTestBirthdayEmail() {
      ...
      if (res) { res.style.display = "block"; res.style.background = "#FDF0E6"; res.style.borderLeftColor = "#3b82f6"; res.style.color = "#1e40af"; res.textContent = "⏳ Sending test birthday email..."; }
