var dash_contributions = [];
    ...
    function _dashShowMonthDetail(month, income, expense) {
      ...
      const html = '<div class="_mhdr"><h3><i class="fa-solid fa-chart-column" style="color:#C1440E;margin-right:6px;"></i> ' + _dashEsc(month) + '</h3><button class="_mcls" onclick="closeModal()">×</button></div>'
