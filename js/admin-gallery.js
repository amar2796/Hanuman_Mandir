var _glryB64 = null, _glryFileName = "";
    ...
    function glryHandleDrop(e) {
      ...
      dz.style.borderColor = "#ddd"; dz.style.background = "rgba(193, 68, 14,0.04)";
    ...
    function glryConfirmCrop() {
      ...
      btn.disabled = false;
      btn.style.cssText = "background:#C1440E;color:#fff;border:none;padding:11px 28px;border-radius:8px;font-weight:600;font-size:14px;cursor:pointer;width:100%;transition:background 0.2s;";
    ...
    async function uploadGalleryPhoto() {
      ...
      try {
        ...
        if (res.status === "success") {
          ...
          btn.disabled = false;
          btn.style.cssText = "background:#C1440E;color:#fff;border:none;padding:11px 28px;border-radius:8px;font-weight:600;font-size:14px;cursor:pointer;width:100%;";
          btn.innerHTML = '<i class="fa-solid fa-upload"></i>&nbsp; Upload to Gallery';
    ...
    async function loadGalleryAdmin() {
      ...
      try {
        ...
        grid.innerHTML =
          ...
          " &nbsp;<button onclick='loadGalleryAdmin()' style='background:#C1440E;color:#fff;border:none;padding:4px 10px;border-radius:6px;font-size:12px;cursor:pointer;'>Retry</button></p>";
      }
    }
