      ...
      let html = `
        ...
        g.GoalName || ""
          ...
          <div class="_mft">
            ...
            <button class="_mbtn" style="background:#C1440E;" onclick="saveEditGoal(_goalStore['${_gk}'])"><i class="fa-solid fa-check"></i> Save</button>
          </div>`;
      ...
      const html = `
        ...
        <div class="_mbdy">
          <div style="border:1px solid #f0f0f0;border-radius:10px;padding:4px 16px;">
            <div class="_row"><span class="_rl">Tracking ID</span><span class="_rv" style="color:#C1440E;font-family:monospace;">${escapeHtml(displayRID)}</span></div>
