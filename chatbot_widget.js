/* ═══════════════════════════════════════════════════════════════
  ...
  #_mbotHelpBubble::after {
    ...
    border-left-color: rgba(193, 68, 14,0.35);
  }
  ...
  #_mbotBtn {
    ...
    background: linear-gradient(135deg, #C1440E, #F59E0B);
    box-shadow: 0 6px 22px rgba(193, 68, 14,0.45);
    cursor: pointer; display: flex; align-items: center; justify-content: center;
    font-size: 24px; border: 3px solid #fff;
    transition: transform 0.22s ease, box-shadow 0.22s ease;
    user-select: none;
  }
  #_mbotBtn:hover { transform: scale(1.1); box-shadow: 0 8px 28px rgba(193, 68, 14,0.55); }
  ...
  #_mbotHdr {
    ...
    border-top: 3px solid #C1440E; flex-shrink: 0;
  }
  ...
  #_mbotHdr .mbot-logo {
    ...
    border-radius: 50%;
    object-fit: cover;
    border: 2px solid rgba(193, 68, 14,0.55);
    box-shadow: 0 0 10px rgba(193, 68, 14,0.35);
    flex-shrink: 0;
    background: #7A1F1F;
  }
  ...
  #_mbotHdr .mbot-avatar {
    ...
    background: #C1440E; display: flex; align-items: center;
    justify-content: center; font-size: 17px; flex-shrink: 0;
  }
  #_mbotHdr .mbot-title { flex: 1; }
  #_mbotHdr .mbot-title div:first-child { color: #C1440E; font-size: 13px; font-weight: 700; font-family: Poppins, sans-serif; }
  ...
  .mbot-msg.user {
    align-self: flex-end; background: #C1440E; color: #fff;
  ...
  .mbot-pill:hover { background: #C1440E; border-color: #C1440E; color: #fff; }
  ...
  #_mbotInput:focus { border-color: #C1440E; background: #fff; }
  #_mbotSend {
    width: 36px; height: 36px; border-radius: 50%; border: none;
    background: #C1440E; cursor: pointer; display: flex;
    align-items: center; justify-content: center;
    font-size: 15px; flex-shrink: 0; color: #fff;
    transition: background 0.18s, transform 0.15s;
  }
  #_mbotSend:hover { background: #7A1F1F; transform: scale(1.08); }
  #_mbotUnread {
